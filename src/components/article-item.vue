<template>
    <section id="article_item" v-if="aid">
        ...
        <div v-if="commentBoxOpen" class="comment-render-container">
            ...
            <p v-if="!commentIsAllowed" class="reviews-disabled-text">
...
import commentHeadSectionVue from "./comment-head-section.vue";
...
export default {
    ...
    methods: {
        ...
        roundUpItemUsers() {
            ...
            let users = [];
            for (let each of this.itemData.comments) {
                if (each) {
                    users.push(each.commentedByInfo.MID);
    ...
    components: {
        commentHeadSection: commentHeadSectionVue,
        replyHeadSection: replyHeadSectionVue,
    },
    created: function () {
        this.restoreRepliesThrottingDefault();
        if (this.$store.state.savedContent_Articles[this.aid]) {
            this.itemData = this.$store.state.savedContent_Articles[this.aid];
        } else {

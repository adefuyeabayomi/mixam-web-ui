<template>
    <section v-view="itemInView" v-if="noShow" id="course_item">
                    ...
                    >
                        <div class="comment-heading">
                            <div
                                ...
                                @click="
                                    viewAuthorProfile(review.reviewedByInfo.MID)
                                "
                            >
                                <div
                                    v-if="
...
export default {
    ...
    created: function () {
        /**
        if (this.resdata == undefined || this.cid == undefined) {
            this.noShow = false;
        }
 */
        let link = `${this.$store.state.apiServer}/gu/course/?cid=${

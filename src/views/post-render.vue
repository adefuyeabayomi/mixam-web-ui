<template>
  <section id="post-render" v-if="pid !== ''">
    <post-render-item @report="submitReportReq" :pid="pid"></post-render-item>
    <modal
      class="report-modal"
      name="report"
      width="90%"
...
<script>
import postRenderItemVue from "@/components/post-render-item.vue";
export default {
  data: function () {
    return {
      pid: "",
  ...
  computed: {},
  components: {
    postRenderItem: postRenderItemVue,
  },
  methods: {

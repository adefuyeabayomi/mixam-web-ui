<template>
  ...
  <div id="myaccount-main-container">
    <section id="header-section">
      ...
      <h3 class="pagemain-header" style="text-align: center">
        Terms &amp; Conditions
      </h3>
      <p class="pagefollow-text"></p>
    ...
    <p>Welcome to <b>Mixam Business</b> (“Company”, “we”, “our”, “us”)!</p>
    <p>
      These Terms of Service (“Terms”, “Terms of Service”) govern your use of
      our website located at <b>https://mixam-business.onrender.com</b> (together or
      individually “Service”) operated by <b>Mixam Business</b>.
    </p>
    <p>
    ...
    <p>
      ...
      <b>adefuyeabayomi16@gmail.com</b> so we can try to find a solution. These
    ...
    <p>
      Mixam Business has the right but not the obligation to monitor and edit
      all Content provided by users.
    </p>
    <p>
      In addition, Content found on or through this Service are the property of
      Mixam Business or used with permission. You may not distribute, modify,
    ...
    <p>
      ...
      Mixam Business and its licensors. Service is protected by copyright,
      ...
      written consent of Mixam Business.
    </p>
    ...
    <p>
      ...
      adefuyeabayomi16@gmail.com, with the subject line: “Copyright
    ...
    <p>
      You may provide us either directly at adefuyeabayomi16@gmail.com or via
    ...
    <p>
      ...
      are not owned or controlled by Mixam Business.
    </p>
    <p>
      Mixam Business has no control over, and assumes no responsibility for the
    ...
    <p>
      ...
      Nigeria, which governing law applies to agreement without regard to its
    ...
    <p>
      ...
      email: <b>adefuyeabayomi16@gmail.com</b>.
    </p>
    <p style="margin-top: 5em; font-size: 0.7em">
      ...
      <a href="https://policymaker.io/terms-and-conditions/"
        >Terms of Service</a
      >
      were created for <b>https://mixam-business.onrender.com</b> by
      <a href="https://policymaker.io">PolicyMaker.io</a> on 2022-06-30.
    </p>
  </div>
</template>
